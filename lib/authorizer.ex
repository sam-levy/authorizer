defmodule Authorizer do
  defmacro defpermit(call, do: expr) do
    ...
    quote do
      ...
      def validate_claim(%Authorizer.Claim{} = claim) do
        claim
      rescue
        _ ->
          raise ArgumentError, "The first argument of defpermit should always be a %Authorizer.Claim{} struct"
      end
      ...
      def validate_role(%Authorizer.Claim{} = claim, role) do
      ...
      defoverridable validate_claim: 1, set_action: 2, validate_role: 2, validate_permission: 1, handle_result: 2
    end
  end
end
